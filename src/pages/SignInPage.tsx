...
const SignInPage: React.FC = () => {
    return (
        <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-white">
            ...
            <div className="flex flex-col items-center justify-center p-8 bg-brand-100/40 relative overflow-hidden">
                ...
                {/* Mobile Logo Only */}
                <div className="lg:hidden mb-12 animate-fadeIn relative z-10">
                    <img
                        src="/Vasantham Enterprises Full Logo.svg"
                        alt="Vasantham Enterprises"
                        className="h-14"
                ...
                <div className="absolute bottom-10 left-0 right-0 text-center text-slate-400 text-[10px] font-black tracking-[0.2em] uppercase transition-opacity hover:opacity-100 opacity-100">
